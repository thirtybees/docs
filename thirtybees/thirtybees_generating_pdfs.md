...
```
destination: ../doc_outputs/thirtybees/designers-pdf
url: "http://127.0.0.1:4010"
baseurl: "/thirtybees/designers-pdf"
port: 4010
output: pdf
...
Open the thirtybees_1_multiserve_pdf.sh file in the root directory and customize it for your specific configuration files. 
...
Open up thirtybees_2_multibuild_pdf.sh and look at the Prince commands:
...
For more detail about using `unless` in conditional logic, see {{site.data.thirtybees.thirtybees_urls.thirtybees_conditional_logic.link}}. What this code means is "run this code unless this value is the case."
