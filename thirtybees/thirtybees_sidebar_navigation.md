...
{{site.data.alerts.note}} For basic information about configuring the sidebar navigation, see {{site.data.thirtybees.thirtybees_urls.thirtybees_configure_sidebar.link}}. This section gets into the top sidebar navigation in more depth.{{site.data.alerts.end}}

When you set up your project, you configured the sidebar following the instructions in {{site.data.thirtybees.thirtybees_urls.thirtybees_configure_sidebar.link}}. In this topic, I dive deeper into other aspects of the sidebar.
...
```yaml
    - title: Understanding how the sidebar works
      url: /thirtybees/thirtybees_understand_sidebar.html
