...
{{site.data.alerts.tip}}In the descriptions of the build scripts, "thirtybees" is used as the sample project. Substitute in whatever your real project name is. {{site.data.alerts.end}}
