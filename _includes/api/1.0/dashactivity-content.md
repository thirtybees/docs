The dash activity is a module that comes standard with thirty bees. This module is not configurable from the modules page and is configurable from the main dashboard.
